...
var _jsxFileName = "/Users/aaronmoskowitz/Advanced-React/sick-fits/frontend/components/CreateItem.js";
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                data = new FormData();
                data.append("file", files[0]); // The following append(args) are defined in from Cloudinary

                data.append("upload_preset", "sickfits"); //hit the cloudinary api

                _context.next = 7;
                return fetch("https://api.cloudinary.com/v1_1/dextp6klr/image/upload", {
                  method: "POST",
                  body: data
                });
              ...
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 3:
                      res = _context2.sent;
                      console.log(res); //go to item's page
...
var _jsxFileName = "/Users/aaronmoskowitz/Advanced-React/sick-fits/frontend/pages/sell.js";
